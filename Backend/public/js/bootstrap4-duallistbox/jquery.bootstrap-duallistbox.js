...
(function (factory) {
    ...
    var pluginName = "bootstrapDualListbox",
        defaults = {
            ...
            removeAllLabel: "Hủy di chuyển tất cả",
            moveOnSelect: true, // true/false (forced true on androids, see the comment later)
            moveOnDoubleClick: true, // true/false (forced false on androids, cause moveOnSelect is forced to true)
            preserveSelectionOnMove: false, // 'all' / 'moved' / false
            selectedListLabel: false, // 'string', false
            nonSelectedListLabel: false, // 'string', false
            helperSelectNamePostfix: "_list", // 'string_of_postfix' / false
            selectorMinimalHeight: 100,
            showFilterInputs: true, // whether to show filter inputs
            nonSelectedFilter: "", // string, filter the non selected options
            selectedFilter: "", // string, filter the selected options
            infoText: "Đang hiển thị tất cả {0} phim", // text when all options are visible / false for no info text
            infoTextFiltered:
                '<span class="badge badge-warning">Đã lọc được</span> {0} kết quả từ danh sách.', // when not all of the options are visible due to the filter
            infoTextEmpty: "Danh sách rỗng", // when there are no options present in the list
    ...
    function refreshInfo(dualListbox) {
        ...
        if (all1 === 0) {
            ...
            content = formatString(dualListbox.settings.infoText, [
                visible1,
                all1,
            ]);
        } else {
    ...
    BootstrapDualListbox.prototype = {
        init: function () {
            ...
            this.container = $(
                "" +
                    ...
                    "   <label>Danh sách phim chính</label>" +
                    '   <h5 style="font-weight:bold; margin:1rem 0 0 0;">Danh sách phim chính</h5>' +
                    ...
                    "   <label>Danh sách phim muốn xếp lịch</label>" +
                    '   <h5 style="font-weight:bold; margin:1rem 0 0 0;">Danh sách chọn phim xếp lịch</h5>' +
                    '   <span class="info-container">' +
                    '     <span class="info"></span>' +
            ...
            var select1Id = "nonselected-list_" + this.originalSelectName,
                select2Id = "selected-list_" + this.originalSelectName;
        ...
        setMoveOnSelect: function (value, refresh) {
            ...
            if (this.settings.moveOnSelect) {
                ...
                this.elements.moveButton.insertAfter(
                    this.elements.moveAllButton
                );
