        ...
        <div class="container">
            ...
            <form method="POST" action="{{url('/them-san-pham')}}" class="was-validated d-flex flex-column input-form"
                ...
                <div class="form-group col-12">
                    ...
                    <input type="text" class="form-control" id="ten-phim" placeholder="Nhập tên sản phẩm  " name="ten_san_pham"
                        required>
                ...
                <div class="form-group d-flex">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control" id="ngay-dk-chieu" name="thong_tin" placeholder="Nhập thông tin sản phẩm" required>
                        <div class="invalid-feedback">Không được bỏ trống trường này</div>
                    </div>

                    <div class="col-4">
                        <label for="ngay-dk-chieu">Xuất xứ</label>
                        <input type="text" class="form-control" id="ngay-dk-chieu" name="xuat_xu" placeholder="Nhập thông tin sản phẩm" required>
                        <div class="invalid-feedback">Không được bỏ trống trường này</div>
                    </div>
                    {{-- <div class="col-4">
