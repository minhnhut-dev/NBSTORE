<div style="font-family:'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif;direction:ltr">
    <table class="m_-6158600730156614244main" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#F2F2F2">
        <tbody>
            <tr>
                <td class="m_-6158600730156614244outer-box" bgcolor="#F2F2F2" align="center" style="padding:0 8px">
                    ...
                    <table class="m_-6158600730156614244width-550 m_-6158600730156614244br-24" style="max-width:550px;border-radius:24px; background: #ffffff;" width="100%" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0">
                        <tbody>
                            <tr>
                                <td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td bgcolor="#f4f4f4" align="left" style="padding:0px 30px 30px 30px;color:#555;font-family:Arial,Helvetica,sans-serif;font-size:13px;font-weight:400;line-height:18px">
                                    <image src="https://khaihuy.com.vn/images/content/banner_s383.jpg" style=" display: block;
                                                            width: 100%;
                                                            object-fit: cover;">
                                    </image>
                                </td>
